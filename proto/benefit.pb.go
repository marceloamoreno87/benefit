...
// Deprecated: Use NewBenefit.ProtoReflect.Descriptor instead.
...
func (x *Users) Reset() {
	*x = Users{}
	if protoimpl.UnsafeEnabled {
		mi := &file_proto_benefit_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Users) Descriptor() ([]byte, []int) {
	return file_proto_benefit_proto_rawDescGZIP(), []int{3}
}
...
var file_proto_benefit_proto_rawDesc = []byte{
	...
	,
...
var file_proto_benefit_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_proto_benefit_proto_goTypes = []interface{}{
	(*NewBenefit)(nil), // 0: proto.NewBenefit
	(*Benefit)(nil),    // 1: proto.Benefit
	(*User)(nil),       // 2: proto.User
	(*Users)(nil),      // 3: proto.Users
}
var file_proto_benefit_proto_depIdxs = []int32{
	1, // 0: proto.User.beneficios:type_name -> proto.Benefit
	2, // 1: proto.Users.users:type_name -> proto.User
	0, // 2: proto.BenefitService.GetBenefit:input_type -> proto.NewBenefit
	3, // 3: proto.BenefitService.GetBenefit:output_type -> proto.Users
...
func file_proto_benefit_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_proto_benefit_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Users); i {
			case 0:
				return &v.state
			case 1:
